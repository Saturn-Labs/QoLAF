	...
	public class TurretManager
	{
		...
		public function damaged(message:Message, pointer:int):void
		{
			...
			if (turret.isAddedToCanvas)
			{
				...
				if (Game.instance.playerManager.me != null && Game.instance.playerManager.me.ship != null && TargetSystem.getDistance(Game.instance.playerManager.me.ship, turret) < 600 && enabledAutoTarget)
