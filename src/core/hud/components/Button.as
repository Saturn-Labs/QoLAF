package core.hud.components
{
	...
	public class Button extends Sprite
	{
		...
		public function Button(param1:Function, param2:String = "I'm a button yeah", param3:String = "normal", param4:int = 13, param5:String = "font13")
		{
			...
			{
				normalTexture = Game.assets.getTexture("ButtonNormalBitmap");
				highlightTexture = Game.assets.getTexture("ButtoHighlightBitmap");
				positiveTexture = Game.assets.getTexture("ButtonPositiveBitmap");
				warningTexture = Game.assets.getTexture("ButtonWarningBitmap");
			}
			updateStyle();
			addChild(styleImage);
			addChild(hoverImage);
