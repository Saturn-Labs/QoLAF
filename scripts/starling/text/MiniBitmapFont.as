package starling.text {
	...
	internal class MiniBitmapFont {
		...
		private static function getBitmapData() : BitmapData {
			var _local4:int = 0;
			var _local2:BitmapData = new BitmapData(128,64);
			var _local3:ByteArray = new ByteArray();
			var _local1:int = int(BITMAP_DATA.length);
			_local4 = 0;
			while(_local4 < _local1) {
				_local3.writeUnsignedInt(BITMAP_DATA[_local4]);
				_local4++;
			}
			_local3.uncompress();
			_local2.setPixels(new Rectangle(0,0,128,64),_local3);
			_local3.clear();
			return _local2;
		}
