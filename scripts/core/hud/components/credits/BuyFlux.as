package core.hud.components.credits {
	...
	public class BuyFlux extends starling.display.Sprite {
		...
		private function addPaymentInfo() : void {
			...
			var _local1:Quad = new Quad(bgWidth,3,5131854);
			_local1.y = textLayer.height + 30;
			textLayer.addChild(_local1);
			var _local2:Image = new Image(textureManager.getTextureGUIByTextureName("paypal_secure"));
			_local2.x = bgWidth - _local2.width;
			_local2.y = _local1.y - _local2.height - 10;
		...
		private function addSuperRewards() : void {
			...
			var _local3:TextBitmap = new TextBitmap(0,textLayer.height + 20,Localize.t("Earn flux and Mobile Payment"),16);
			_local3.format.color = 15582483;
			textLayer.addChild(_local3);
			var _local4:TextField = new TextField(500,30,Localize.t("Earn flux or pay with your mobile, game cards or other payment method"),new TextFormat("Verdana",12,0xffffff,"left"));
			_local4.x = 0;
			_local4.y = _local3.y + 20;
			textLayer.addChild(_local4);
			var _local5:Image = new Image(textureManager.getTextureGUIByTextureName("superrewards_large"));
			_local5.x = bgWidth - _local5.width;
			_local5.y = _local3.y;
			textLayer.addChild(_local5);
			var _local2:Bitmap = new GetFluxNowButtonAsset();
			var _local1:NativeImageButton = new NativeImageButton(onBuySuperRewards,_local2.bitmapData);
			_local1.y = _local4.y + _local4.height + 10;
			nativeLayer.addChild(_local1);
		}
