package core.states.gameStates {
	...
	public class PodState extends PlayState {
		...
		override public function enter() : void {
			...
			buy1Button.x = 265;
			buy1Button.y = 428;
			buy1Button.textFormat.color = 0xffffff;
			...
			buy10Button.x = 415;
			buy10Button.y = 428;
			buy10Button.textFormat.color = 0xffffff;
			...
			nrOfPodsText = new TextField(100,30,"---",new TextFormat("DAIDRR",12,0xaaaaaa));
			nrOfPodsText.x = 11 * 60;
			nrOfPodsText.y = 55;
...
class Pod extends Sprite {
	...
	public function Pod(g:Game) {
		...
		new ToolTip(g,center,Localize.t("Click to open!"),null,"PodState");
		this.addChild(top);
	...
	public function listenForClick(callback:Function) : void {
		...
		center.addEventListener("triggered",(function():* {
			...
			return f = function():void {
				...
				cTween = TweenMax.fromTo(center,0.5,{"color":0xffffff},{
					"color":0xff00ff,
					"yoyo":true,
					"repeat":-1
				});
