		...
		private function drawEditView(clanId:String) : void {
			...
			dataManager.loadKeyFromBigDB("Clans",clanId,function(param1:Object):void {
				...
				changeColor = new Button(function():void {
					...
					logo.color = Color.RGBtoHEX(_local1,_local3,_local2);
					inputColor.text = _local1 + "," + _local3 + "," + _local2;
				...
				changeLogo = new Button(function():void {
					var _local2:Array = clanObj.logo.split("clan_logo");
					var _local1:int = 1;
					if(_local2.length > 1) {
						_local1 = int(_local2[1]);
					}
					if(_local1 == 3) {
						_local1 = 0;
					}
					clanObj.logo = "clan_logo" + (_local1 + 1).toString();
				...
				logo.addEventListener("touch",function(param1:TouchEvent):void {
					...
					if(param1.getTouch(logo,"began")) {
						_local3 = clanObj.logo.split("clan_logo");
						_local2 = 1;
						if(_local3.length > 1) {
							_local2 = int(_local3[1]);
						}
						if(_local2 == 3) {
							_local2 = 0;
						}
